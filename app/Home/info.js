...
const Info = () => {
    return(
        <>
        <div className=' w-[100%] px-[50px] py-[100px] '>
            <div className='flex flex-col items-center p-[50px]'>
                <h1 className='text-[50px] font-bold pb-[20px]'>About Us</h1>
                <p className='text-[20px] font-medium px-[20px]'>Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere Lorem ipsum sere</p>
            </div>
